...
const items: SettingsSectionItem<FinishedSettings>[] = [
  {
    ...
    description:
      "If enabled, the extension will not ask you for additional information like notes. It will immediately mark the work as finished.",
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Reread Worthy",
        input: enumSelect(DisplayMode),
        dataField: "displayModes.rereadWorthy",
      },
      {
        type: FormItemType.FIELD,
        sectionId: SectionId.FINISHED_SETTINGS,
        label: "Completed",
        input: enumSelect(DisplayMode),
        dataField: "displayModes.statusCompleted",
      },
      {
        type: FormItemType.FIELD,
        sectionId: SectionId.FINISHED_SETTINGS,
        label: "Dropped",
        input: enumSelect(DisplayMode),
        dataField: "displayModes.statusDropped",
      },
      {
        type: FormItemType.FIELD,
        sectionId: SectionId.FINISHED_SETTINGS,
        label: "Dormant",
        input: enumSelect(DisplayMode),
        dataField: "displayModes.statusDormant",
      },
    ],
  },
  {
